"""Native cognis-connect emit for obscan — forward findings to any platform.

Maps obscan's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    obscan ... --format json | obscan-emit --to stix
    obscan-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
